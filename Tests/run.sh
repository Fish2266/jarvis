...
swiftc -O $T -o "$OUT/matcher" \
    Jarvis/PhraseMatcher.swift Jarvis/AppIndex.swift Jarvis/Macro.swift Jarvis/Minecraft.swift \
...
swiftc -O $T -o "$OUT/browser" \
    Jarvis/Browser.swift Jarvis/Macro.swift Jarvis/Minecraft.swift Jarvis/AppLauncher.swift \
...
echo
echo "===== minecraft, game or launcher ====="
swiftc -O $T -o "$OUT/minecraft" \
    Jarvis/PhraseMatcher.swift Jarvis/AppIndex.swift Jarvis/Macro.swift \
    Jarvis/Minecraft.swift Jarvis/Resolver.swift Jarvis/AppLauncher.swift \
    Jarvis/Browser.swift Tests/minecraft/main.swift
"$OUT/minecraft"
...
swiftc -O $T -o "$OUT/answers" \
    ...
    Jarvis/Questions.swift Jarvis/Resolver.swift Jarvis/Macro.swift Jarvis/Minecraft.swift \
